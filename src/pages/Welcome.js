...
const Welcome = ({trash, deleteItem, add, onChange, item, data, form, goBack}) =>(
                        ...
                        data.map(
                            (item, i) => (
                                <tr key={i}>
                                    ...
                                    <td>{item.id}</td>
                                    <td>{item.name}</td>
                                    <td className="text-center"><button id={item.id} onClick={(e) => deleteItem(item) } className="btn btn-danger">X</button></td>
                                </tr>
                            )
                        )
                    }
